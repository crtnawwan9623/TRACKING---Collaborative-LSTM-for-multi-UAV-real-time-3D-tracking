...
def main():
    ...
    parser.add_argument('--seq_length', type=int, default=40, #original value 20
    ...
    parser.add_argument('--neighborhood_size', type=int, default=1, #original value 32, 720 for CLSTM, 1 for LSTM
    ...
    parser.add_argument('--grid', action="store_true", default=False, #original value True
...
def train(args):
    ...
    if not os.path.isdir("log/"):
      ...
      subprocess.call([f_prefix+'/make_directories.sh'],shell=True)
